...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="relative overflow-hidden py-16 md:py-24 min-h-[600px] flex flex-col justify-center" style={{ backgroundImage: 'linear-gradient(180deg, #E4332F 0%, #F79133 40%, #FDEB37 100%)'}}>
